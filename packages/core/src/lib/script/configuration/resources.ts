/**
 * The shape of the grantable-resource catalog.
 *
 ...
 * service that fills the catalog, and the permission governing who may see it, live in
...
interface GrantableCollection {
   ...
   * the two are indistinguishable here on purpose. A catalog that failed loudly on one unreadable
